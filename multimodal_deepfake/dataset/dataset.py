...
class ICMR_Dataset(Dataset):
    def __init__(self, config, ann_file, transform, max_words=30, is_train=True): 
        
        self.root_dir = '/home/jiyoung.lee/ICMR2024/datasets'       
        self.ann = []
        with open(ann_file[0], 'r' ) as file:
            for line in file:
    ...
    def __getitem__(self, index):    
        ...
        label = ann['context_label']
        # caption = pre_caption(ann['caption1'], self.max_words)
        caption = pre_caption(ann['caption1'], self.max_words)
        # fake_text_pos = ann['fake_text_pos']
